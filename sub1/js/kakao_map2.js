 window.onload = function() {
    ...
    var options = {
        center: new daum.maps.LatLng(37.236521,127.110982),
        level: 2
    };
    ...
    var markerPosition  = new daum.maps.LatLng(37.236521,127.110982); 
    ...
    var options2 = {
        center: new daum.maps.LatLng(36.842732, 127.118634),
        level: 2
    };
    ...
    var markerPosition2  = new daum.maps.LatLng(36.842732, 127.118634); 
   ...
   var options3 = {
       center: new daum.maps.LatLng(36.706039, 127.409936),
       level: 2
   };
   ...
   var markerPosition3  = new daum.maps.LatLng(36.706039, 127.409936); 
